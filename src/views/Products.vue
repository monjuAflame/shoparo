            ...
            <div class="modal-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-8">
                    ...
                    <div class="form-group">
                      <!-- <textarea name="description" class="form-control" v-model="product.description" id=""></textarea> -->
        ...
        var uploadTask = storageRef.put(file);
          ...
          uploadTask.on('state_changed', (snapshot) => {
            ...
            uploadTask.snapshot.ref.getDownloadURL().then((downloadURL) => {
              ...
              // this.product.image = downloadURL; //for single image
              this.product.images.push(downloadURL); //for multiple image
            });
          });
      }
